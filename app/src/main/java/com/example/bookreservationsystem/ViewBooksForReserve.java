...
public class ViewBooksForReserve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(data.getCount() == 0){
            Toast.makeText(ViewBooksForReserve.this, "The database is emptyt !", Toast.LENGTH_LONG).show();
        }else{
...
//                        Intent editScreenIntent = new Intent(ViewBooksForReserve.this, UpdateBooks.class);
...
//                    }else {
//                        Toast.makeText(ViewBooksForReserve.this, "No ID associated with that name !", Toast.LENGTH_LONG).show();
//                    }
//                }
//            });
...
//                        Log.d(TAG, "onItemClick: The Author is " + author);
//                        Log.d(TAG, "onItemClick: The Year is " + year);
                        Intent editScreenIntent = new Intent(ViewBooksForReserve.this, AddNewReservation.class);
                        editScreenIntent.putExtra("id",bookID);
                        editScreenIntent.putExtra("bookName", bookName);
...
//                    openAddNewReservation();
    ...
    private void openAddNewReservation() {
        Intent intent = new Intent(this, AddNewReservation.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(ViewBooksForReserve.this, android.R.layout.simple_list_item_1, bookslist);
